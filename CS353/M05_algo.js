...
window.AlgoWidgets[3] = function(container) {
  container.innerHTML = '<div class="algo-widget">' +
        ...
        function generateSteps() {
          var arr = [];
          var numElements = 8; 
          for(var i=0; i<numElements; i++) arr.push(Math.floor(Math.random()*80)+20); 
        ...
        function render() {
          ...
          s.array.forEach(function(val, idx) {
            ...
            indexText.setAttribute('y', SVG_HEIGHT + 15); 
          ...
          var pointerY_i = SVG_HEIGHT - BAR_MAX_HEIGHT - POINTER_OFFSET_Y; 
          var pointerY_j = SVG_HEIGHT + POINTER_OFFSET_Y + 15; 
