...
window.AlgoWidgets[1] = function(container) {
  container.innerHTML = '<div class="algo-widget">' +
    ...
    var MAX_Y_VALUE = Math.max(t_n(MAX_N), c1_g_n(MAX_N)) * 1.05; 
    ...
    function render() {
      ...
      svgContent += '<line x1="' + PADDING_LEFT + '" y1="' + scaleY(0) + '" x2="' + (SVG_WIDTH - PADDING_RIGHT) + '" y2="' + scaleY(0) + '" stroke="var(--algo-text)" stroke-width="2"/>'; 
      svgContent += '<line x1="' + PADDING_LEFT + '" y1="' + PADDING_TOP + '" x2="' + PADDING_LEFT + '" y2="' + scaleY(0) + '" stroke="var(--algo-text)" stroke-width="2"/>'; 
